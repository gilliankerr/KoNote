...
- **[Browser] Responsive Layout** `/clients/5/`
  [mobile] Client detail: Touch target too small — <button> "Actions ▾" is 80x28px (min 44x44)

- **[Browser] Responsive Layout** `/clients/5/`
  [mobile] Client detail: Touch target too small — <button> "+ New ▾" is 76x28px (min 44x44)
...
- **[Browser] Responsive Layout** `/clients/5/`
  [mobile] Client detail: Touch target too small — <a> "Notes (1)" is 89x38px (min 44x44)

- **[Browser] Responsive Layout** `/clients/5/`
  [mobile] Client detail: Touch target too small — <a> "History (2)" is 99x38px (min 44x44)
...
- **[INFO]** `/clients/5/` — [mobile] Client detail: Touch target too small — <button> "Actions ▾" is 80x28px (min 44x44)

- **[INFO]** `/clients/5/` — [mobile] Client detail: Touch target too small — <button> "+ New ▾" is 76x28px (min 44x44)
...
- **[INFO]** `/clients/5/` — [mobile] Client detail: Touch target too small — <a> "Notes (1)" is 89x38px (min 44x44)

- **[INFO]** `/clients/5/` — [mobile] Client detail: Touch target too small — <a> "History (2)" is 99x38px (min 44x44)
