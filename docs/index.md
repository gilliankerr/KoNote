...
| **Set up KoNote2 for the first time** | [Deploying KoNote2](deploying-KoNote2.md) — local setup, cloud hosting |
| **Configure my agency's settings** | [Administering KoNote2](administering-KoNote2.md) — terminology, programs, users, backups |
| **Learn how to use KoNote2 daily** | [Using KoNote2](using-KoNote2.md) — staff training guide |
...
- [Finding Clients](using-KoNote2.md#finding-a-client)
- [Writing Progress Notes](using-KoNote2.md#writing-progress-notes)
- [Recording Events](using-KoNote2.md#recording-events)
- [Viewing Plans](using-KoNote2.md#viewing-the-outcome-plan)

### For Deployment

- [Local Development (Docker)](deploying-KoNote2.md#local-development-docker)
- [Deploy to Railway](deploying-KoNote2.md#deploy-to-railway)
- [Deploy to Azure](deploying-KoNote2.md#deploy-to-azure)
- [Deploy to Elestio](deploying-KoNote2.md#deploy-to-elestio)
- [PDF Reports Setup](deploying-KoNote2.md#pdf-report-setup)
...
- **Documentation issues:** [Open an issue on GitHub](https://github.com/your-org/KoNote2-web/issues)
